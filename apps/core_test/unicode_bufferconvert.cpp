...
TEST( BufferConvert, Null )
{
	...
	ASSERT_CHAR( c, '\0' );
	c = 'a';
	ASSERT_EQ( ConvertToASCII( &c, 1, u8"\0", 2 ), 2 );
	ASSERT_CHAR( c, '\0' );
	c = 'a';
	...
	u8 = 'a';
	ASSERT_EQ( ConvertToUtf8( &u8, 1, "\0", 2 ), 2 );
	ASSERT_CHAR( u8, u8'\0' );
	u8 = 'a';
	ASSERT_EQ( ConvertToUtf8( &u8, 1, u8"\0", 2 ), 2 );
	ASSERT_CHAR( u8, u8'\0' );
	u8 = 'a';
	ASSERT_EQ( ConvertToUtf8( &u8, 1, u"\0", 2 ), 2 );
	ASSERT_CHAR( u8, u8'\0' );
	u8 = 'a';
	ASSERT_EQ( ConvertToUtf8( &u8, 1, U"\0", 2 ), 2 );
	ASSERT_CHAR( u8, u8'\0' );
	...
	ASSERT_CHAR( u, u'\0' );
	u = 'a';
	ASSERT_EQ( ConvertToUtf16( &u, 1, u8"\0", 2 ), 2 );
	ASSERT_CHAR( u, u'\0' );
	u = 'a';
	...
	ASSERT_CHAR( U, U'\0' );
	U = 'a';
	ASSERT_EQ( ConvertToUtf32( &U, 1, u8"\0", 2 ), 2 );
	ASSERT_CHAR( U, U'\0' );
	U = 'a';
