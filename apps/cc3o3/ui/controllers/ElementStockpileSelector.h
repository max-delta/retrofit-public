...
public:
	...
	static constexpr gfx::ppu::CoordElem kContainerWidth = kElementTilesetFull.mTileWidth;
	static constexpr gfx::ppu::CoordElem kContainerHeight = kElementTilesetFull.mTileHeight *
