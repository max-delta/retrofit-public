...
inline constexpr FramePackProto kTextTruncation = { "text_truncation", 16, 16 };
inline constexpr FramePackProto kTextCompletion = { "text_completion", 16, 16 };

}
///////////////////////////////////////////////////////////////////////////////
namespace mockup {

inline constexpr FramePackProto kWiggle64 = { "mock_wiggle_64", 64, 64 };
inline constexpr FramePackProto kWiggle32 = { "mock_wiggle_32", 32, 32 };
inline constexpr FramePackProto kWiggle16 = { "mock_wiggle_16", 16, 16 };
inline constexpr FramePackProto kWiggle8 = { "mock_wiggle_8", 8, 8 };
