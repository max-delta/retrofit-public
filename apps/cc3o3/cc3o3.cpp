...
#include "cc3o3/appstates/devtest/DevTestElementLab.h"
...
void Startup()
{
	...
	if( kAllowDevTests )
	{
		...
		sAppStateManager.AddState( appstate::id::DevTestElementLab, DefaultCreator<appstate::DevTestElementLab>::Create() );
...
void DebugInstantReplay( size_t numFrames )
{
	...
	RFLOGF_INFO( nullptr, RFCAT_CC3O3, "Instant replay triggered for frames {} -> {}",
		rollMan.GetHeadClock().time_since_epoch(),
		sInstantReplayEndTime.time_since_epoch() );
}
