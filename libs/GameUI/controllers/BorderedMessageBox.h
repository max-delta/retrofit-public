...
// Message box combined with a border
RF_TODO_ANNOTATION( "Consider deprecating this entirely in favor of MessageBox and BorderFrame" );
class GAMEUI_API BorderedMessageBox final : public InstancedController
{
	RFTYPE_ENABLE_VIRTUAL_LOOKUP();
	RF_NO_COPY( BorderedMessageBox );

	//
	// Public methods
public:
	BorderedMessageBox() = delete;
	BorderedMessageBox(
		size_t numRows,
