...
TEST(MathCompare, Basic)
{
	...
	static_assert( Equals<float>( 1.f, 1.f + rftl::numeric_limits<float>::epsilon() ), "Unsafe precision required" );
	...
	static_assert( Equals<double>( 1.0, 1.0 + rftl::numeric_limits<double>::epsilon() ), "Unsafe precision required" );
