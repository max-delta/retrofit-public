...
TEST(MathCasts, IntegerTruncast_Unsigned)
{
	...
	uint64_t u64 = integer_truncast<uint64_t>( huge );
	uint64_t u32 = integer_truncast<uint32_t>( huge );
	uint64_t u16 = integer_truncast<uint16_t>( huge );
	uint64_t u8 = integer_truncast<uint8_t>( huge );
...
TEST(MathCasts, IntegerTruncast_Signed)
{
	...
	int64_t huge = std::numeric_limits<int64_t>::lowest();
	int64_t s64 = integer_truncast<int64_t>( huge );
	int64_t s32 = integer_truncast<int32_t>( huge );
	int64_t s16 = integer_truncast<int16_t>( huge );
	int64_t s8 = integer_truncast<int8_t>( huge );
...
{
	{
		...
		uint8_t val = integer_truncast<uint8_t>(source);
		ASSERT_EQ( val, 0 );
	}
	{
