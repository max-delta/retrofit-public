...
public:
	...
	static rftl::deque<rftl::deque<rftl::basic_string<char8_t>>> TokenizeToDeques( rftl::u8string_view const& buffer );
	...
	static rftl::deque<rftl::deque<rftl::basic_string<char8_t>>> TokenizeToDeques( rftl::u8string_view const& buffer, char8_t separator );
