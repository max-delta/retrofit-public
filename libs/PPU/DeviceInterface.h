...
public:
	...
	virtual DeviceFontID CreateBitmapFont( rftl::byte_view const& buffer, uint32_t& characterWidth, uint32_t& characterHeight, rftl::array<uint32_t, 256>* variableWidth, rftl::array<uint32_t, 256>* variableHeight ) = 0;
