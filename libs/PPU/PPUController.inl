...
{
	return DrawTextVA( pos, details::kDefaultTextLayer, desiredHeight, font, false, math::Color3u8::kBlack, fmt.get(), rftl::make_format_args( args... ) );
}
...
{
	return DrawTextVA( pos, zLayer, desiredHeight, font, false, math::Color3u8::kBlack, fmt.get(), rftl::make_format_args( args... ) );
}

template<typename... ArgsT>
inline bool PPUController::DrawText( Coord pos, DepthLayer zLayer, uint8_t desiredHeight, ManagedFontID font, math::Color3u8 color, rftl::format_string<ArgsT...> fmt, ArgsT&&... args )
{
	return DrawTextVA( pos, zLayer, desiredHeight, font, false, color, fmt.get(), rftl::make_format_args( args... ) );
}

template<typename... ArgsT>
inline bool PPUController::DrawText( Coord pos, DepthLayer zLayer, uint8_t desiredHeight, ManagedFontID font, bool border, math::Color3u8 color, rftl::format_string<ArgsT...> fmt, ArgsT&&... args )
{
...
template<typename... ArgsT>
inline bool PPUController::DebugDrawAuxText( Coord pos, DepthLayer zLayer, uint8_t desiredHeight, ManagedFontID font, bool border, math::Color3u8 color, rftl::format_string<ArgsT...> fmt, ArgsT&&... args )
{
